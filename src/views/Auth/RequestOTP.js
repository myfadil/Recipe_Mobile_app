...
export default function RequestOTPView({navigation}) {
    ...
    <View style={{flex: 1}}>
      <View style={styles.container}>
        <View style={styles.lock}>
          ...
          />
          <Text style={MainStyle.headerText}>Request OTP</Text>
          <Text style={{textAlign: 'center', color: '#C4C4C4'}}>
            We just need your registered e-mail address to send your OTP
          </Text>
        </View>
